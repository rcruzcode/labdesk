...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do LabDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o LabDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o LabDesk no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao LabDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao LabDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("setup_server_tip", "Conectado ao Servidor LabDesk"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o LabDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [LabDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep LabDesk background service", "Manter o serviço do LabDesk executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do LabDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do LabDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do LabDesk."),
        ...
        ("verify_labdesk_password_tip", "Verifique a senha do LabDesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o LabDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_labdesk_server_pro_to_{}_tip", "Atualize o LabDesk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o LabDesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por LabDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do LabDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço LabDesk em segundo plano"),
